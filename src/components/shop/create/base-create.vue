<template>
	<el-form ref="form" label-width="80px">
		...
		<el-form-item label="商品描述">
			<el-input type="textarea" class="w-50" :value="desc" @input="vModel('desc',$event)" :rows="5" placeholder="选填,商品卖点简述,例如:此款商品美观大方 性价比较高 不容错过">
			</el-input>
		</el-form-item>
		<el-form-item label="商品单位">
			<el-input :value="unit" style="width: 200px;" @input="vModel('unit',$event)" placeholder="请输入商品单位"></el-input>
		</el-form-item>
		<el-form-item label="总库存">
			<el-input type="number" :value="stock" @input="vModel('stock',$event)" style="width: 165px;">
				<template slot="append">件</template>
			</el-input>
		</el-form-item>
		<el-form-item label="库存预警">
			<el-input type="number" :value="min_stock" @input="vModel('min_stock',$event)" style="width: 165px;">
				<template slot="append">件</template>
			</el-input>
		</el-form-item>
