			...
			<el-col :span="6" v-for="(item,index) in counts" :key="index">
				<el-card class="box-card" shadow="hover">
					<div class="d-flex align-items-center">
						<i :class="[item.icons,item.color]" class="border h4 mb-0 text-white text-center mr-3" style="width: 40px;height: 40px;line-height: 40px;">
						</i>
						<div>
		...
		<el-row :gutter="20" class="my-3">
			...
			<el-col :span="12">
				<el-card class="box-card" shadow="never">
					<div slot="header" class="clearfix">
						<span>dd</span>
						<el-button style="float: right; padding: 3px 0" type="text">ss</el-button>
					</div>
			...
			<el-col :span="12">
				<el-card class="box-card" shadow="never">
					...
					<el-table :data="tableData" height="165" border style="width: 100%">
						<el-table-column type="index" label="#" width="50">
						</el-table-column>
						<el-table-column prop="name" label="商品信息">
						</el-table-column>
						<el-table-column prop="num" label="销量" width="100">
						</el-table-column>
