				...
				<el-form ref="form" v-model="form" label-width="80px">
					...
					<el-form-item label="注册类型" label-width="150px">
						<el-radio-group v-model="form.reg_type" size="mini">
							<el-radio-button label="普通注册">普通注册</el-radio-button>
							<el-radio-button label="手机注册">手机注册</el-radio-button>
						</el-radio-group>
					</el-form-item>
					<el-form-item label="密码最小长度" label-width="150px">
						<el-input size="mini" style="width: 25%;" v-model="form.password_length"></el-input>
					</el-form-item>
			...
			<el-tab-pane label="上传设置" name="second">
				<el-form ref="form" v-model="form" label-width="80px">
					...
					<el-form-item label="Bucket" label-width="150px">
						<el-input size="mini" style="width: 25%;" v-model="form.Bucket"></el-input>
					</el-form-item>
					<el-form-item label="ACCESS_KEY" label-width="150px">
						<el-input size="mini" style="width: 50%;" v-model="form.ACCESS_KEY"></el-input>
					</el-form-item>
					<el-form-item label="SECRET_KEY" label-width="150px">
						<el-input size="mini" style="width: 50%;" v-model="form.SECRET_KEY"></el-input>
					</el-form-item>
					<el-form-item class="mb-0" label="空间域名" label-width="150px">
						<el-input size="mini" style="width: 50%;" v-model="form.http"></el-input>
					</el-form-item>
					<el-form-item label-width="150px">
						<p class="mb-0" style="font-size: 12px;">请补全http://或https://</p>
						<el-button type="primary" size="mini">保存</el-button>
					</el-form-item>
				</el-form>
			</el-tab-pane>
			<el-tab-pane label="Api安全" name="third">
				<el-form ref="form" v-model="form" label-width="80px">
					...
					<el-form-item label="密钥" label-width="150px">
						<el-input size="mini" style="width: 50%;" v-model="form.api_key"></el-input>
						<p class="mb-0" style="font-size: 12px;">
